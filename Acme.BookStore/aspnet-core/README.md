...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p bef0b806-db89-4b57-a07b-86b919e50152
```

> `bef0b806-db89-4b57-a07b-86b919e50152` is the password of the certificate, you can change it to any password you want.
